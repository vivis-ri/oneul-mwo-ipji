...
// 시 단위 지역을 도/광역시별로 묶은 목록 (커뮤니티 지역 선택용)
// 각 그룹 안에서 가나다 순으로 정렬됨
export const CITY_GROUPS = [
  { province: '서울특별시', cities: ['서울'] },
  { province: '부산광역시', cities: ['부산'] },
  { province: '인천광역시', cities: ['인천'] },
  ...
  { province: '경기도', cities: ['가평','고양','과천','광명','광주(경기)','구리','군포','김포','남양주','동두천','부천','성남','수원','시흥','안산','안성','안양','양주','양평','여주','연천','오산','용인','의왕','의정부','이천','파주','평택','포천','하남','화성'] },
  { province: '강원특별자치도', cities: ['강릉','고성(강원)','동해','삼척','속초','양구','양양','영월','원주','인제','정선','철원','춘천','태백','평창','홍천','화천','횡성'] },
  { province: '충청북도', cities: ['괴산','단양','보은','영동','옥천','음성','제천','증평','진천','청주','충주'] },
  { province: '충청남도', cities: ['계룡','공주','금산','논산','당진','보령','부여','서산','서천','아산','예산','천안','청양','태안','홍성'] },
  { province: '전북특별자치도', cities: ['고창','군산','김제','남원','무주','부안','순창','완주','익산','임실','장수','전주','정읍','진안'] },
  { province: '전라남도', cities: ['강진','고흥','곡성','광양','구례','나주','담양','목포','무안','보성','순천','신안','여수','영광','영암','완도','장성','장흥','진도','함평','해남','화순'] },
  { province: '경상북도', cities: ['경산','경주','고령','구미','김천','문경','봉화','상주','성주','안동','영덕','영양','영주','영천','예천','울릉','울진','의성','청도','청송','칠곡','포항'] },
  { province: '경상남도', cities: ['거제','거창','고성(경남)','김해','남해','밀양','사천','산청','양산','의령','진주','창녕','창원','통영','하동','함안','함양','합천'] },
  { province: '제주특별자치도', cities: ['서귀포','제주'] },
];
